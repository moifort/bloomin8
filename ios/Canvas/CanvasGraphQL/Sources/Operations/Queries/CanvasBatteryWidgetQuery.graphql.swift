...
public class CanvasBatteryWidgetQuery: GraphQLQuery {
  public static let operationName: String = "CanvasBatteryWidget"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query CanvasBatteryWidget { canvasBattery { __typename percentage lastFullChargeDate lastPullDate } }"#
    ))
